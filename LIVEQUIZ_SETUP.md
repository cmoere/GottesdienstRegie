...
4. Die autorisierte Domain `cmoere.github.io` unter **Authentication → Settings → Authorized domains** eintragen, falls sie dort noch nicht vorhanden ist.
...
4. Teilnehmer öffnen `https://cmoere.github.io/GottesdienstRegie/quiz/` oder scannen den QR-Code.
