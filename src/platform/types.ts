...
export interface CloudMediaAsset extends OnlineMediaAsset{favorite?:boolean;tags?:string[];createdAt?:string;extension?:string;lastUsedAt?:string;aiGenerated?:boolean;visibility?:'private'|'team'|'community'}
