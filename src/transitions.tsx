...
export const transitionLabels={cut:'Kein Übergang',fade:'Überblenden',crossfade:'Kreuzblende',dissolve:'Auflösen',slide:'Schieben',wipe:'Wischen'} as const;
...
export function TransitionStage({slide,transition,role='main',previewToken=0}:{slide:Slide;transition:SlideTransition;role?:DisplayRole;previewToken?:number}){
  ...
  return <div className={`transition-stage transition-${effective.type} direction-${direction} ${active?'active':''}`} style={style}>
